...
Console.WriteLine($"form reservoirs (SDF backend slice): {receipt.SdfReservoirCount:N0}");
Console.WriteLine($"appearance reservoirs (PBR backend slice): {receipt.PbrReservoirCount:N0}");
Console.WriteLine($"transport reservoirs (radiosity backend slice): {receipt.RadiosityReservoirCount:N0}");
...
Console.WriteLine("shader: D3D12 compute, independent GPU-resident Form/Appearance/Transport reservoir passes");
